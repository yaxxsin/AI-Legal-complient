...
- [x] Prisma schema + Supabase connection
...
framework scaffolding (Next.js + NestJS), database schema via Prisma, Supabase auth config, 
...
- apps/web: package.json, layouts, middleware, supabase clients, sidebar, topbar
