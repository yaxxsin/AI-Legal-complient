...
export default function LoginPage() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {/* Google SSO placeholder — Phase 2 */}
      ...
      <button
        type="button"
        disabled
        className="w-full h-11 rounded-xl border border-border bg-card text-muted-foreground text-sm font-medium flex items-center justify-center gap-2 opacity-50 cursor-not-allowed"
      >
